                                ...
                                <div class="card">
                                    <div class="card-body pb-0 d-flex justify-content-between">
                                        <div>
                                                        ...
                                                        foreach ($datas as $key => $data) {
                                                            echo '
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="show_kategori.php?id='.$data['id_kategori'].'" class="btn btn-primary button-blue" style="color=white;">Lihat</a>
                                                                        <a href="edit_kategori.php?id='.$data['id_kategori'].'" class="btn btn-primary button-blue" style="color=white;">Edit</a>
                                                                        <a href="delete_kategori.php?id='.$data['id_kategori'].'" class="btn btn-primary button-blue" style="color=white;">Hapus</a>
                                                                    </td>
                                                                </tr>
                                                            ';
                                                        }
                                            ...
                                            <a href="create_kategori.php" class="btn btn-primary mb-4" style="color:white;">Tambah Kategori</a>
                                            <a href="../../print_kategori.php" class="btn btn-primary mb-4" style="color:white;">Cetak Daftar Kategori</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
