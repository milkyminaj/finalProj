...
<body>
    <?php
        ...
        if(isset($_POST['data_submit'])){
            ...
            $sql = "UPDATE kategori SET kategori_berita = '$kategori_berita' WHERE id_kategori = $id;";
            $datas = $conn->query($sql);
                                    ...
                                    <div class="card-body">
                                                ...
                                                <form action="<?php echo $_SERVER['PHP_SELF']. "?id=".$id ?>" method="post">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="kategori_berita" name="kategori_berita" placeholder="Nama Kategori" value="<?php echo $kategori_berita ?>">
                                                    </div>
