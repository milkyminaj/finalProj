...
<body>
    <?php
        ...
        $sql = "INSERT INTO kategori (kategori_berita) VALUES ('$kategori_berita');";
                            ...
                            <!--<div class="col-12">-->
                                <div class="card">
                                    <div class="card-body pb-0 d-flex justify-content-between">
                                        <!--<div class="card">-->
                                            <div class="card-body">
                                                <h3 class="mb-5">Menambah Kategori</h3>
                                                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                                    <div class="mb-3">
                                                        <label for="kategori_berita" class="form-label">Judul Kategori</label>
                                                        <input type="text" class="form-control" id="kategori_berita" name="kategori_berita" placeholder="Judul Kategori" required>
                                                    </div>
