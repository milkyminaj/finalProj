            ...
            <div class="container-fluid mt-3">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">News Reader</h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white">New Readers</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">4565</h2>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                <h3 class="card-title text-white">Reader Satisfaction</h3>
                                <div class="d-inline-block">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body pb-0 d-flex justify-content-between">
                                        <div>
                                            <h4 class="mb-1">News Readers</h4>
                                            <p>Total Readers of the Month</p>
                                        </div>
                                        <div>
                                            <ul>
                ...
                <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Reader Summary</h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card card-widget">
                                <div class="card-body">
                                    <h5 class="text-muted">Reader Overview </h5>
                                    <h2 class="mt-4">5680</h2>
                                    <span>Total Revenue</span>
                                    <div class="mt-4">
                                        <h4>30</h4>
                                        <h6>Facebook Share <span class="pull-right">30%</span></h6>
                                    ...
                                    <div class="mt-4">
                                        <h4>50</h4>
                                        <h6 class="m-t-10 text-muted">Twitter Share <span class="pull-right">50%</span></h6>
                                        <div class="progress mb-3" style="height: 7px">
                                    ...
                                    <div class="mt-4">
                                        <h4>20</h4>
                                        <h6 class="m-t-10 text-muted">Instagram Share <span class="pull-right">20%</span></h6>
                                        <div class="progress mb-3" style="height: 7px">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-12 col-sm-12 col-xxl-12">
                        <div class="card">
                            <div class="card-body">
                                    <h4 class="card-title mb-0">Readers Location</h4>
