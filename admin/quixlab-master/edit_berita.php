...
<body>
    <?php
        ...
        if(isset($_POST['data_submit'])){
            ...
            $sql = "UPDATE berita SET gambar = '$gambar', judul = '$judul', date = '$date', penulis = '$penulis', konten = '$konten', id_kategori = '$id_kategori' WHERE id = $id;";
            $datas = $conn->query($sql);

            if (mysqli_affected_rows($conn) > 0) {
                header("Location:index_berita.php");
            } else{
                $_SESSION['error'] = "Menyunting Data Gagal";
            }
        }
    ?>
                        ...
                        <!--<div class="row">-->
                            <!--<div class="col-12">-->
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                                <h3 class="mb-5">Menyunting Data Berita</h3>
                                                <form action="<?php echo $_SERVER['PHP_SELF']. "?id=".$id ?>" method="post">
                                                    <div class="mb-3">
                                                        <label for="gambar" class="form-label">Pilih Thumbnail</label>
                                                        <input type="file" class="form-control" id="gambar" name="gambar" placeholder="Judul / URL gambar" value="<?php echo $gambar ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="judul" class="form-label">Judul Berita</label>
                                                        <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul Berita" required value="<?php echo $judul ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="date" class="form-label">Tanggal Upload</label>
                                                        <input type="text" class="form-control" id="date" name="date" placeholder="YYYY/MM/DD" required value="<?php echo $date ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="penulis" class="form-label">Author</label>
                                                        <input type="text" class="form-control" id="penulis" name="penulis" placeholder="Author" required value="<?php echo $penulis ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="konten" class="form-label">Isi Konten Berita</label>
                                                        <textarea type="text" class="form-control" id="konten" name="konten" required><?php echo $konten ?></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" aria-label="Default select example" name="id_kategori">
                                                            ...
                                                            ?>
                                                            <input type="text" class="form-control" id="id_kategori" name="id_kategori" placeholder="ID Kategori Berita" required value="<?php echo $id_kategori ?>">
                                                        </select>
                                                    </div>
